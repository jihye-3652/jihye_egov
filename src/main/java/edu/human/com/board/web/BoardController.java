...
public class BoardController {
	 ...
	 */
	@RequestMapping(value="/admin/board/selectBoard.do") // (value="/admin/board/selectBoard.do" , method=RequestMethod.GET) //list.jsp 34 line // method="post"
	public String selectBoard(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		//게시판 ID 값 초기화 : KJH 20200824
